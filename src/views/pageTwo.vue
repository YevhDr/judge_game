...
<div style='margin-bottom: 50px'>
    ...
    <div v-show="open" class="text-width" style="text-align:left; font-style: italic; color:grey; font-size: 14px;">
      ...
      <p style="line-height:1.8">Влітку 2021 року Верховна Рада зробила спробу запровадити такі зміни. Закони <a href="https://zakon.rada.gov.ua/laws/show/1629-20#Text">№1629-ІХ</a> та <a href="https://zakon.rada.gov.ua/laws/show/1635-20#Text">№1635-ІХ</a> передбачили створення незалежної Конкурсної комісії для відбору членів Вищої кваліфкомісії суддів та Етичної ради для перевірки на доброчесність членів та кандидатів до Вищої ради правосуддя. Обидва органи наполовину складаються з українських суддів, а наполовину з українських експертів.</p>
