...
<div style='margin-bottom: 50px'>
    ...
    <div v-show="open" class="text-width" style="text-align:left; font-style: italic; color:grey; font-size: 14px;">
      <p style="line-height:1.8">Як бачите, головна проблема криється у тому, що суддівські долі вершать такі самі негідники. Система влаштована так, що судді самостійно обирають більшість членів Вищої ради правосуддя і Вищої кваліфікаційної комісії суддів.&nbsp;</p>
